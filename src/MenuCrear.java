        ...
        CREARCLIENTEButton.addActionListener(e -> {
            ...
            while (true) {
                ...
                if (esRut) {
                    ...
                    String rutIngresado = txtRut.getText().replaceAll("\\s", "").toUpperCase();
                    if (rutIngresado.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "**El campo RUT no puede estar vacío**", "AVISO", JOptionPane.WARNING_MESSAGE);
                        continue clienteLoop;
                    }

                    try {
                        idCliente = new utilidades.Rut(rutIngresado);
                    } catch (Exception ex) {
                    ...
                    String pasIngresado = txtPasaporte.getText().trim();
                    String nacIngresada = txtNacionalidad.getText().trim().toUpperCase();

                    if (pasIngresado.isEmpty() || nacIngresada.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "**Los campos no pueden estar vacíos**", "AVISO", JOptionPane.WARNING_MESSAGE);
                        continue clienteLoop;
                    }

                    idCliente = new utilidades.Pasaporte(pasIngresado, nacIngresada);
                }
                ...
                while(true) {
                    ...
                    if (nombre.isEmpty() || apPaterno.isEmpty() || apMaterno.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "**Las casillas de nombres no pueden estar vacías**", "AVISO", JOptionPane.WARNING_MESSAGE);
                    } else {
                        break;
                    }
                }
                ...
                if (confirmacion == 0) {
                    try {
                        ...
                        if (msg != null && msg.toLowerCase().contains("ya existe cliente")) {
                            JOptionPane.showMessageDialog(this, "**Este cliente ya esta registrado en el sistema**", "AVISO", JOptionPane.WARNING_MESSAGE);
                        } else {
